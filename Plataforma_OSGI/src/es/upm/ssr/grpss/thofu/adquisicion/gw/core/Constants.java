...
public class Constants {
	...
	public static final int DB_DUMP_PERIOD = 15000; //ms
	
	//Period for threshold subscription checker
	public static final int TH_CHECKER = 10000; //ms
	
	//Max pool of threads for Threshold manager
	public static final int MAX_THREAD_POOL = 500;
	
	//Drivers
	 public static enum Driver { MICAZ, SUNSPOT, BIOHARNESS, SUPERVISOR };

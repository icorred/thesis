...
//            " goes on <" + page + "," + row + "," + col + ">");
        document.getElementById("id-" + page + "-" + row + "-" + col).
            innerHTML = "<ul id=\"sddm\"><li> Frecuencia Cardiaca</li></ul>";
...
//            " goes on <" + page + "," + row + "," + col + ">");
            ...
            innerHTML = "<ul id=\"sddm\"><li> Temperatura Corporal</li></ul>";
//        alert("Drawing tile " + "dev-" + page + "-" + row + "-" + col);
        drawBodyTemp(deviceObj[i],
            document.getElementById("dev-" + page + "-" + row + "-" + (col+1)));
			
			
			document.getElementById("id-" + page + "-" + row + "-" + (col+2)).
            innerHTML = "<ul id=\"sddm\"><li> Postura </li></ul>";
//        alert("Drawing tile " + "dev-" + page + "-" + row + "-" + col);
        drawPosture(deviceObj[i],
            document.getElementById("dev-" + page + "-" + row + "-" + (col+2)));

					...
					case 0:
					    ...
					    if (c==0){
							...
							if(loading == 0){
								...
								document.getElementById("dev-" + page + "-" + r + "-" + c).
								innerHTML = "<ul id=\"sddm\"><li><br/><br/> Esperando Sensor de Temperatura</li></ul>";
							
							} else if(deviceObj[c+i-1].temp.value[9] != null){
							 ...
							 // alert("Drawing temperature tile " + "dev-" + page + "-" + r + "-" + c);
								...
								document.getElementById("dev-" + page + "-" + r + "-" + c).
								innerHTML = "<ul id=\"sddm\"><li><br/><br/> Sensor de Temperatura no disponible</li></ul>";
					...
					case 1:
						...
						if (c==0){
							...
							if(loading == 0){
								...
								document.getElementById("dev-" + page + "-" + r + "-" + c).
								innerHTML = "<ul id=\"sddm\"><li><br/><br/> Esperando Sensor de Humedad</li></ul>";
							
							} else if(deviceObj[c+i-1].hum.value[9] != null){
							
							//alert("Valor hum "+deviceObj[c+i-1].hum.value[9]);
							 // alert("Drawing temperature tile " + "dev-" + page + "-" + r + "-" + c);
								drawHum(deviceObj[c+i-1], document.getElementById("dev-" + page + "-" + r + "-" + c));
							} else  if (deviceObj[c+i-1].hum.value[9] == null){
							
								document.getElementById("dev-" + page + "-" + r + "-" + c).
								innerHTML = "<ul id=\"sddm\"><li><br/><br/> Sensor de Humedad no disponible</li></ul>";
							}
					...
					case 2: 
						...
						if (c==0){
							...
							if(loading == 0){
								...
								document.getElementById("dev-" + page + "-" + r + "-" + c).
								innerHTML = "<ul id=\"sddm\"><li><br/><br/> Esperando Sensor de Luz</li></ul>";
							
							} else if(deviceObj[c+i-1].light.value[9] != null){
						 // alert("Drawing temperature tile " + "dev-" + page + "-" + r + "-" + c);
								...
								document.getElementById("dev-" + page + "-" + r + "-" + c).
								innerHTML = "<ul id=\"sddm\"><li><br/><br/> Sensor de Luz no disponible</li></ul>";
							}

 ...
 * This class implements a Java interface to the 'ProxMsg'
 * message type.
 */
package driver_micaz_osgi;

public class ProxMsg extends net.tinyos.message.Message {
    ...
    /** Create a new ProxMsg of size 12. */
    public ProxMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new ProxMsg of the given data_length. */
    public ProxMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ProxMsg with the given data_length
     * and base offset.
     */
    public ProxMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ProxMsg using the given byte array
     * as backing store.
     */
    public ProxMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public ProxMsg(byte[] data, int base_offset) {
     ...
     */
    public ProxMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new ProxMsg embedded in the given message
     * at the given base offset.
     */
    public ProxMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public ProxMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
